...
class DetailsScreenViewModel @Inject constructor(
    private val photoRepository: WebDataRepositoryImpl,
    private val favouritesRepository: DatabaseRepositoryImpl
) : ViewModel(){
...
//    }
//
//    private fun assignPhoto(photo: PhotoModelDomain?){
...
//    }
//
//    fun actionOnFavouriteButton(photo: PhotoModelDomain){
//        viewModelScope.launch {
...
//    }
//
//    suspend fun addToFavourites(photo: PhotoModelDomain) {
//        viewModelScope.launch {
...
//    }
//
//    suspend fun removeFromFavourites(photo: PhotoModelDomain) {
//        viewModelScope.launch {
