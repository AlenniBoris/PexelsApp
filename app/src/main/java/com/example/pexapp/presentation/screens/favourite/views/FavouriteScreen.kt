...
import com.example.pexapp.presentation.navigation.Route
import com.example.pexapp.presentation.uikit.views.AppEmptyScreen

@Composable
fun FavouriteScreen(
    navHostController: NavHostController,
    favouriteScreenViewModel: com.example.pexapp.presentation.screens.favourite.FavouriteScreenViewModel = hiltViewModel()
) {
