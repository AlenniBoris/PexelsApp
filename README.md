...
- To use it after downloading from Github, you have to get your API key from Pexels. If you don't have it, check the official [page](https://www.pexels.com/). Thean create apikeys.properties file and save it there.
